...
const EpisodePlay = () =>{
    ...
    const location = useLocation();
      ...
      const getEpisodePlay = (access_token, operator_uid, user_id) => {
        ...
        var config = {
            method: 'get',
            url: `https://ott.tvanywhereafrica.com:28182/api/client/v1/${operator_uid}/users/${user_id}/vod/episodes/${location.state.detail.id}`,
            headers: {
    ...
    useEffect(() => {
        ...
        getEpisodePlay(access_token, operator_uid, user_id)
    }, [])
    ...
    return(
      ...
      <div>
          ...
          <br/>
          <br/>
          loading location information, no location information please visit the episode series page
      </div>
      : 
      ...
      <div className="">
          ...
          <div className="mainlivetv" style={{marginLeft: "3%", marginTop: "2%"}}>
                    <Link className="" style ={{ border: "none", width: "",textDecoration: "none" }}
                                     to = {{
