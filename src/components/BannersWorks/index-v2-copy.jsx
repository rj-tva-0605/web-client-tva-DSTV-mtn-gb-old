...
import SliderComp, {useFetch, SliderData}  from "./SliderData-copy";
...
const Banners = () => {
    ...
    const fetchdata =  () => {
        ...
        const sliderarray = dataslider.map(({banner_image_id, title}) => {
            return ({banner_image_id, title} )
              
            })
          
          setDatax(sliderarray)
          console.log('this is the data', sliderarray)

              
          console.log("data from SLIDERCOMPONENT", sliderarray);
                ...
                <div className="dashboard-banners-main-content  ">
                    {/* cards div for banners and content comes here */}
                        ...
                        <div className="BannerApp">
                            <Slider {...settings}>
                                {console.log(datax)}
                                {datax.map(({banner_image_id, title}, idx) => (
